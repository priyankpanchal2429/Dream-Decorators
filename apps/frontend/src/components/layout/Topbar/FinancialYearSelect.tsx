      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute right-0 mt-2 w-72 origin-top-right rounded-2xl glass-panel border border-borderClr/50 bg-cardBg/95 shadow-2xl p-2 z-50 backdrop-blur-xl focus:outline-none"
            role="listbox"
            tabIndex={-1}
          >
