...
interface CreateInvoiceFormProps {
  ...
  onUpdateItem: (id: string, field: keyof InvoiceItem, val: any) => void;
}
...
export const CreateInvoiceForm: React.FC<CreateInvoiceFormProps> = ({
  ...
  return (
    <div className="space-y-6">
      {/* 2-Column Grid: Client Information & Invoice Details */}
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        {/* Left Column (7 cols): Client Information */}
        <div className="lg:col-span-7 glass-panel p-5 sm:p-6 rounded-2xl space-y-4">
          <div className="flex items-center justify-between pb-3 border-b border-borderClr/30">
            <div className="flex items-center gap-2.5">
              ...
              <div>
                ...
                <p className="text-[10px] text-txtSecondary">Customer billing profile and GST state code</p>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
            ...
            <div>
              ...
              <input
                type="text"
                placeholder="e.g. Royal Living Pvt Ltd"
                value={companyName}
        ...
        {/* Right Column (5 cols): Invoice Metadata */}
        <div className="lg:col-span-5 glass-panel p-5 sm:p-6 rounded-2xl space-y-4">
          <div className="flex items-center justify-between pb-3 border-b border-borderClr/30">
            <div className="flex items-center gap-2.5">
              ...
              <div>
                <h3 className="text-xs font-bold text-txtPrimary">Sales Invoice Details</h3>
                <p className="text-[10px] text-txtSecondary">Invoice number, issue date & due terms</p>
              </div>
            </div>
          </div>
        ...
        <div className="flex flex-wrap items-center justify-between gap-3 pb-2.5 border-b border-borderClr/30">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <p className="text-[10px] text-txtSecondary">Manage billed items, item notes, HSN/SAC codes, UOM, and GST tax calculations</p>
            </div>
          </div>
